...
public class SearchJournalRepositoryImpl extends QuerydslRepositorySupport implements SearchJournalRepository{
  public SearchJournalRepositoryImpl(Class<?> domainClass) {
    super(domainClass);
  }
  ...
  public Page<Object[]> searchPage(String type, String keyword, Pageable pageable) {
    ...
    jpqlQuery.leftJoin(qPhotos).on(qPhotos.journal.eq(qPhotos));
    jpqlQuery.leftJoin(qComments).on(qComments.journal.eq(qComments));
